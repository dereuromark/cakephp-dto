 ...
 *
 * @method array{name: string|null} toArray(?string $type = null, ?array $fields = null, bool $touched = false)
 * @method static static createFromArray(array{name: string|null} $data, bool $ignoreMissing = false, ?string $type = null)
 *
 * @deprecated Yeah, sry
 */
