 ...
 *
 * @method array{title: string, meta: array<string, string>} toArray(?string $type = null, ?array $fields = null, bool $touched = false)
 * @method static static createFromArray(array{title: string, meta: array<string, string>} $data, bool $ignoreMissing = false, ?string $type = null)
 */
