 ...
 *
 * @method array{url: string, number: int, state: string, title: string, body: string, user: array<string, mixed>, createdAt: string, labels: array<string, \Sandbox\Dto\Github\LabelDto>, head: array<string, mixed>|null, base: array<string, mixed>|null} toArray(?string $type = null, ?array $fields = null, bool $touched = false)
 * @method static static createFromArray(array{url: string, number: int, state: string, title: string, body: string, user: array<string, mixed>, createdAt: string, labels: array<string, \Sandbox\Dto\Github\LabelDto>, head: array<string, mixed>|null, base: array<string, mixed>|null} $data, bool $ignoreMissing = false, ?string $type = null)
 */
class PullRequestDto extends AbstractDto {
	...
	*/
	...
	/**
	 * @param array{url: string, number: int, state: string, title: string, body: string, user: array<string, mixed>, createdAt: string, labels: array<string, \Sandbox\Dto\Github\LabelDto>, head: array<string, mixed>|null, base: array<string, mixed>|null} $data
